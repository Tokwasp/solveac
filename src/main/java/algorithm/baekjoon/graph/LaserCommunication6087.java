...
public class LaserCommunication6087 {
    ...
    static PriorityQueue<Point> queue = new PriorityQueue<>(Comparator.comparingInt(Point::getMirrors));
    ...
    public static void bfs(Point start) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (visited[i][newX][newY] > nextMirror) {
                    visited[i][newX][newY] = nextMirror;
